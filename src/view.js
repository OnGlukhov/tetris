export default class View {
	...
	constructor(element, width, height, rows, columns) {
		...
		this.playfieldInnerHeigh =
			this.playfieldHeigth - this.playfieldBorderWidth * 2

		this.blockWidth = this.playfieldInnerWidth / columns
		this.blockHeight = this.playfieldHeigth / rows

		this.panelX = this.playfieldWidth + 10
		this.panelY = 0
		this.panelWidth = this.width / 3
		this.panelHeigh = this.height
	...
	renrerPanel({ level, score, lines, nextPiece }) {
